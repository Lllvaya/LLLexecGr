...
export const tealTheme = {
  "body": "#F8F9FA", // Light White
  "text": "#3E3A48", // Dark Purple
  "expTxtColor": "#2E2C35", // Dark Grey-Black
  "highlight": "#EEEFF1", // Off White
  "dark": "#1A1A1D", // Blackish Purple
  "secondaryText": "#746A79", // Soft Purple
  "imageHighlight": "#C5B1C6", // Light Lavender
  "compImgHighlight": "#E6E6E6", // Light Grey
  "jacketColor": "#9A8C98", // Soft Purple-Grey
  "headerColor": "#9A8C9877", // Transparent Purple-Grey
  "splashBg": "#3E3A48" // Dark Purple
};
